...
from sd_scripts.device_utils import synchronize_device
from sd_scripts.fp8_optimization_utils import load_safetensors_with_fp8_optimization
from sd_scripts.safetensors_utils import MemoryEfficientSafeOpen, TensorWeightAdapter, WeightTransformHooks, get_split_weight_filenames
...
from sd_scripts.utils import setup_logging
            ...
            for lora_weight_keys, lora_sd, multiplier in zip(list_of_lora_weight_keys, lora_weights_list, lora_multipliers):
                ...
                for prefix in ["lora_unet_", ""]:
                    ...
                    if hada_key in lora_weight_keys:
                        # LoHa merge
                        from networks.loha import merge_weights_to_tensor as loha_merge  # lazy (LoRA support)
                        ...
                        # LoKr merge
                        from networks.lokr import merge_weights_to_tensor as lokr_merge  # lazy (LoRA support)
